...
ARTEMIS_VARIABLE(rad.opac, cross_section);
} // namespace opac
namespace part {
SWARM_VARIABLE(Real, rad.part, flux);
SWARM_VARIABLE(Real, rad.part, v);
SWARM_VARIABLE(Real, rad.part, x);
SWARM_VARIABLE(int, rad.part, ijk);
} // namespace part
} // namespace rad
