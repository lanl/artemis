...
class ArtemisDriver : public EvolutionDriver {
 ...
 protected:
  ...
  bool do_gas, do_dust, do_gravity, do_rotating_frame, do_cooling, do_damping,
      do_viscosity, do_nbody, do_conduction, do_diffusion;
  const bool is_restart;
};

// using TaskCollectionFnPtr = TaskCollection (*)(Mesh *pm, const Real dt);
