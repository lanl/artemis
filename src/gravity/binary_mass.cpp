...
TaskStatus BinaryMassGravity(MeshData<Real> *md, const Real time, const Real dt) {
  ...
  parthenon::par_for(
      ...
      KOKKOS_LAMBDA(const int &b, const int &k, const int &j, const int &i) {
        ...
        Real dxc1[3] = {Null<Real>()};
        Real dxc2[3] = {Null<Real>()};
        Real ex1[3] = {Null<Real>()};
        Real ex2[3] = {Null<Real>()};
        Real ex3[3] = {Null<Real>()};
        coords.ConvertToCartWithVec(dx, dxc1, ex1, ex2, ex3);
        ...
        Real dxs1[3] = {Null<Real>()};
        Real dxs2[3] = {Null<Real>()};
        coords_cart.ConvertToSph(dxc1, dxs1);
        coords_cart.ConvertToSph(dxc2, dxs2);
...
template TaskStatus BinaryMassGravity<C::spherical>(MD *m, const Real t, const Real d);
template TaskStatus BinaryMassGravity<C::axisymmetric>(MD *m, const Real t, const Real d);
