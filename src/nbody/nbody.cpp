  ...
  if (refine_type != "none") {
    ...
    if (refine_distance) {
      if (coords == Coordinates::cartesian) {
        ...
        nbody->CheckRefinementBlock = DistanceRefinement<Coordinates::axisymmetric>;
      } else if (coords == Coordinates::spherical) {
        nbody->CheckRefinementBlock = DistanceRefinement<Coordinates::spherical>;
...
template AmrTag DistanceRefinement<Coordinates::spherical>(MeshBlockData<Real> *md);
template AmrTag DistanceRefinement<Coordinates::axisymmetric>(MeshBlockData<Real> *md);
