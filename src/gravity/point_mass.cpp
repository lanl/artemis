...
template TaskStatus PointMassGravity<G::cartesian>(MD *m, const Real t, const Real d);
template TaskStatus PointMassGravity<G::cylindrical>(MD *m, const Real t, const Real d);
template TaskStatus PointMassGravity<G::spherical1D>(MD *m, const Real t, const Real d);
template TaskStatus PointMassGravity<G::spherical2D>(MD *m, const Real t, const Real d);
template TaskStatus PointMassGravity<G::spherical3D>(MD *m, const Real t, const Real d);
template TaskStatus PointMassGravity<G::axisymmetric>(MD *m, const Real t, const Real d);
