...
//========================================================================================
//! \file hlldc_hall_xmhd.hpp
//! \brief Local Lax Friedrichs (HLLDC_HALL_XMHD) Riemann solver, also known as Rusanov's
//! method, for hydrodynamics.
//!
//! REFERENCES:
//! - E.F. Toro, "Riemann Solvers and numerical methods for fluid dynamics", 2nd ed.,
//!   Springer-Verlag, Berlin, (1999) chpt. 10.
#ifndef UTILS_FLUXES_RIEMANN_HLLDC_HALL_XMHD_HPP_
#define UTILS_FLUXES_RIEMANN_HLLDC_HALL_XMHD_HPP_
...
//----------------------------------------------------------------------------------------
//! \class ArtemisUtils::RiemannSolver<RSolver::hlldc_hall_xmhd, ...>
//! \brief The HLLDC_HALL_XMHD Riemann solver for ideal gas hydrodynamics
template <Fluid FLUID_TYPE>
class RiemannSolver<RSolver::hlldc_hall_xmhd, FLUID_TYPE> {
 public:
...
// ==========================================================================================
	    ...
	    // YH: save rho** for below as HLLDC solver will update it as intermediate for flux
...
// ==========================================================================================
	    ...
	    const Real sL_NI = std::max(spd[0], std::max(wl_ivx - NImax_l, wr_ivx - NImax_r));
	    const Real sR_NI = std::min(spd[4], std::min(wl_ivx + NImax_l, wr_ivx + NImax_r));
	    ...
	    //q.flux(b, dir, iJx, k, j, i) = 0.5*(fl_Jx + fr_Jx);
	    //q.flux(b, dir, iJy, k, j, i) = 0.5*(fl_Jy + fr_Jy);
	    //q.flux(b, dir, iJz, k, j, i) = 0.5*(fl_Jz + fr_Jz);
	    //q.flux(b, dir, iPe, k, j, i) = 0.5*(fl_Se + fr_Se);
...
#endif // UTILS_FLUXES_RIEMANN_HLLDC_HALL_XMHD_HPP_
