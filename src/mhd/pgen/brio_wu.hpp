...
//========================================================================================
#ifndef PGEN_BRIO_WU_HPP_
#define PGEN_BRIO_WU_HPP_
//! \file brio_wu.hpp
//! \brief
//!
...
//----------------------------------------------------------------------------------------
//! \fn void Init_BRIO_WU_Params
//! \brief Extracts brio_wu parameters from ParameterInput.
inline void Init_BRIO_WU_Params(MeshBlock *pmb, ParameterInput *pin) {
  auto &artemis_pkg = pmb->packages.Get("artemis");
  Params &params = artemis_pkg->AllParams();
  if (!(params.hasKey("brio_wu_params"))) {
    BRIO_WU_Params brio_wu_params;
    brio_wu_params.rho0 = pin->GetOrAddReal("problem", "rho0", 1.0);
    brio_wu_params.rhol = pin->GetOrAddReal("problem", "rhol", 1.0);
    brio_wu_params.vxl = pin->GetOrAddReal("problem", "vxl", 0.0);
    brio_wu_params.pl = pin->GetOrAddReal("problem", "pl", 1.0);
    brio_wu_params.pel = pin->GetOrAddReal("problem", "pel", 0.5);
    brio_wu_params.bxl = pin->GetOrAddReal("problem", "bxl", 0.75);
    brio_wu_params.byl = pin->GetOrAddReal("problem", "byl", 1.0);
    brio_wu_params.bzl = pin->GetOrAddReal("problem", "bzl", 0.0);
    brio_wu_params.rhor = pin->GetOrAddReal("problem", "rhor", 0.125);
    brio_wu_params.vxr = pin->GetOrAddReal("problem", "vxr", 0.0);
    brio_wu_params.pr = pin->GetOrAddReal("problem", "pr", 0.1);
    brio_wu_params.per = pin->GetOrAddReal("problem", "per", 0.05);
    brio_wu_params.bxr = pin->GetOrAddReal("problem", "bxr", 0.75);
    brio_wu_params.byr = pin->GetOrAddReal("problem", "byr", -1.0);
    brio_wu_params.bzr = pin->GetOrAddReal("problem", "bzr", 0.0);
    brio_wu_params.xdisc = pin->GetOrAddReal("problem", "xdisc", 0.5);
    params.Add("brio_wu_params", brio_wu_params);
  }
}

//----------------------------------------------------------------------------------------
//! \fn void ProblemGenerator::BRIO_WU()
//! \brief Sets initial conditions for brio_wu problem
...
inline void ProblemGenerator(MeshBlock *pmb, ParameterInput *pin) {
  ...
  // BRIO_WU parameters
  auto shkp = artemis_pkg->Param<BRIO_WU_Params>("brio_wu_params");
