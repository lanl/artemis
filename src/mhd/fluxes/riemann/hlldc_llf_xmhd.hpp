...
//========================================================================================
//! \file hlldc_llf_xmhd.hpp
//! \brief Local Lax Friedrichs (HLLDC_LLF_XMHD) Riemann solver, also known as Rusanov's
//! method, for hydrodynamics.
//!
//! REFERENCES:
//! - E.F. Toro, "Riemann Solvers and numerical methods for fluid dynamics", 2nd ed.,
//!   Springer-Verlag, Berlin, (1999) chpt. 10.
#ifndef UTILS_FLUXES_RIEMANN_HLLDC_LLF_XMHD_HPP_
#define UTILS_FLUXES_RIEMANN_HLLDC_LLF_XMHD_HPP_
...
//----------------------------------------------------------------------------------------
//! \class ArtemisUtils::RiemannSolver<RSolver::hlldc_llf_xmhd, ...>
//! \brief The HLLDC_LLF_XMHD Riemann solver for ideal gas hydrodynamics
template <Fluid FLUID_TYPE>
class RiemannSolver<RSolver::hlldc_llf_xmhd, FLUID_TYPE> {
 public:
...
// ==========================================================================================
	    ...
	    const Real cmax_L = cfl; //std::max(cw_L, cfl);         
	    ...
	    cw_R = std::min(cw_R, c_per_v);
            const Real cmax_R = cfr; //std::max(cw_R, cfr);
...
#endif // UTILS_FLUXES_RIEMANN_HLLDC_LLF_XMHD_HPP_
