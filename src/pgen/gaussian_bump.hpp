...
//----------------------------------------------------------------------------------------
//! \fn void ProblemGenerator::gaussian_bump
//! \brief
...
inline void ProblemGenerator(MeshBlock *pmb, ParameterInput *pin) {
  ...
  bump_params.input_system = geometry::CoordSelect(input_system, ndim);
  bump_params.system = geometry::CoordSelect(system, ndim);
  ...
  pmb->par_for(
      ...
      KOKKOS_LAMBDA(const int k, const int j, const int i) {
        ...
        const auto &xc = coords.ConvertToCart(xi);
