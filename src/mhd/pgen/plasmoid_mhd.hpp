...
//========================================================================================
#ifndef PGEN_PLASMOID_MHD_HPP_
#define PGEN_PLASMOID_MHD_HPP_
//! \file plasmoid_mhd.hpp
//! \brief
//!
...
namespace plasmoid_mhd {

struct PLASMOID_MHD_Params {
  Real beta_up;
};

//----------------------------------------------------------------------------------------
//! \fn void Init_PLASMOID_MHD_Params
//! \brief Extracts plasmoid_mhd parameters from ParameterInput.
inline void Init_PLASMOID_MHD_Params(MeshBlock *pmb, ParameterInput *pin) {
  auto &artemis_pkg = pmb->packages.Get("artemis");
  Params &params = artemis_pkg->AllParams();
  if (!(params.hasKey("plasmoid_mhd_params"))) {
    PLASMOID_MHD_Params plasmoid_mhd_params;
    plasmoid_mhd_params.beta_up = pin->GetOrAddReal("problem", "beta_up", 0.2);
    params.Add("plasmoid_mhd_params", plasmoid_mhd_params);
  }
}

//----------------------------------------------------------------------------------------
//! \fn void ProblemGenerator::PLASMOID_MHD()
//! \brief Sets initial conditions for plasmoid_mhd problem
...
inline void ProblemGenerator(MeshBlock *pmb, ParameterInput *pin) {
  ...
  PARTHENON_REQUIRE(do_gas || do_mhd, "The plasmoid mhd problem requires both gas & mhd!");
  PARTHENON_REQUIRE(!(do_dust), "The plasmoid mhd problem does not permit dust hydrodynamics!");
  ...
  // PLASMOID_MHD parameters
  auto shkp = artemis_pkg->Param<PLASMOID_MHD_Params>("plasmoid_mhd_params");

  // Setup plasmoid_mhd state
  pmb->par_for(
      "plasmoid_mhd", kb.s, kb.e, jb.s, jb.e, ib.s, ib.e,
